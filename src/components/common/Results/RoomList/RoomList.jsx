...
import { BsGeoAltFill, BsMap, BsXLg } from "react-icons/bs";
...
export const RoomList = (roomsData) => {
  ...
  //Nhớ thêm roomId
  const [roomListRawData, setRoomListRawData] = [
    dataProvided.accoms,
    dataProvided.setAccoms,
  ];

  const [roomListFilteredData, setRoomListFilteredData] =
    useState(roomListRawData);
  ...
  const currentRooms = roomListFilteredData.slice(
    indexOfFirstRoom,
    indexOfLastRoom
  );
    ...
    const data = [
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/08/f5/a5/3-bedroom-garden-view.jpg?w=1200&h=-1&s=1",
      ...
      },
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/5b/72/b0/guest-room.jpg?w=1100&h=-1&s=1",
      ...
      },
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/2c/32/66/beachfront-bungalow-outside.jpg?w=1200&h=-1&s=1",
      ...
      {
        address:
          "Tổ 1, Khu du lịch Đức Việt Khu Bãi Trường, Dương Tơ, Đảo Phú Quốc 920000 Việt Nam",
        facilities: [
          "Bữa sáng miễn phí",
          "Chỗ đậu xe",
          "Tiệc BBQ",
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/0c/8d/55/sol-beach-house-phu-quoc.jpg?w=1200&h=-1&s=1",
      ...
      {
        address:
          "Lô D6B2 - D7A1, Nguyễn Tất Thành, Khu 2, Cam Hải Đông 650000 Việt Nam",
        facilities: [
          "Trung tâm thể dục",
          "Tiệc BBQ",
          "Hồ bơi",
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/42/99/06/exterior.jpg?w=1200&h=-1&s=1",
      ...
      },
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/af/32/a3/vinpearl-discovery-coastalland.jpg?w=1200&h=-1&s=1",
      ...
      {
        address:
          "35 Trường Sa Hoa Hai Ward, Ngu Hanh Son District, Đà Nẵng 550000 Việt Nam",
        facilities: [
          "Quầy bar",
          "Wifi",
          "Tiệc BBQ",
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/5e/81/85/exterior.jpg?w=1200&h=-1&s=1",
      ...
      },
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/4e/dc/a3/new-world-phu-quoc-resort.jpg?w=1200&h=-1&s=1",
      ...
      },
      {
        ...
        images: [
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/16/82/44/49/palm-garden-beach-resort.jpg?w=1200&h=-1&s=1",
    ...
    const rulesData = [
      {
        accomId: "accom1",
        checkInTime:
          "Từ " + (Math.floor(Math.random() * 24) + 1 - 1).toString() + ":00h",
        checkOutTime:
          "Trước " +
          (Math.floor(Math.random() * 24) + 1 - 1).toString() +
          ":00h",
        checkInRule:
          "Khách hàng được yêu cầu xuất trình giấy tờ tùy thân trước khi nhận phòng",
        childRule:
          "Trẻ em dưới 12 tuổi được lưu trú miễn phí nếu sử dụng giường có sẵn trong phòng",
        bedRule:
          "Nôi cũi và giường phụ có sẵn và có thể yêu cầu trước. Phụ phí có thể áp dụng.",
    ...
    const roomTypes = [
      {
        ...
        capacity: "2 người",
        area: "50m2",
        facility: ["Ban công", "View biển", "Điều hòa không khí"],
        servive: ["Miễn phí hủy phòng", "Bao bữa sáng"],
      ...
      },
      {
        ...
        area: "60m2",
        facility: ["Ban công", "View biển", "Điều hòa không khí"],
        servive: ["Dịch vụ dọn phòng", "Bữa sáng miễn phí"],
        originalPrice: "10.000.000",
        price: "5.000.000 đ",
        saleoff: "50%",
      },
  ...
  useEffect(() => {
    const rooms = roomListFilteredData.slice(indexOfFirstRoom, indexOfLastRoom);
    let newAddress = [];
    rooms.map((roomData) => {
      fetch(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${roomData.address}.json?access_token=pk.eyJ1IjoiMTYwM25nb2N0cmluaCIsImEiOiJjbGszYWIzdHQwbGV6M25sc3JlMXl2N2I5In0.SWaxHyfB8VPYvvwCd2YF8w`
      )
        .then((response) => {
        ...
        <Popup
          trigger={
            <Button
              iconSize={24}
              preIcon={BsMap}
              className="cyan results-roomlist__map__button"
            >
