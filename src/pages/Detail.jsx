      ...
      <div className="detail">
        ...
        <div className="image-list">
          ...
          <div className="image-list__column">
            <img
              className="image-list__column__item"
              src={accomData.images[1]}
            />
            <img
              className="image-list__column__item"
              src={accomData.images[2]}
            />
          </div>
          <div className="image-list__column">
            <img
                ...
                return (
                  <div className="wrapper" key={index}>
                    ...
                    <div className="infor-reserve">
                      Loại phòng: Phòng 2 giường đơn nhìn ra vườn | Đã ở 3 đêm
