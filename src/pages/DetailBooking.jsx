...
export const DetailBooking = (props) => {
  ...
  const { bookingHistoryData, setBookingHistoryData, roomTypes, orders } =
    dataProvided;
  ...
  const HandleEditAndUpdate = () => {
    if (!isCanEdit) {
      ...
      if (CheckInputValid()) {
        const updateCustomerInfoRef = doc(
          db,
          "orders",
          bookingHistoryData.orderId
        );
  ...
  const CheckInputValid = () => {
    if (
      bookingHistoryData.customerName === "" ||
      bookingHistoryData.customerMail === "" ||
      bookingHistoryData.customerPhone === ""
    ) {
  ...
  const CancelBooking = async () => {
    ...
    const foundOrder = orders.find(
      (order) => order.orderId === bookingHistoryData.orderId
    );
  ...
  return (
    <Helmet title="Chi tiết đặt phòng">
      <div className="detail-booking">
            ...
            <span>
              {"Đặt đặt phòng lúc " +
                (bookingHistoryData?.orderDate
                  ? format(
                      bookingHistoryData.orderDate.toDate(),
                      "hh:mm:ss a, 'ngày' dd/MM/yyyy"
                    )
                  : "...")}
            </span>
          </div>
            ...
            <div id="image-content">
              <div className="image">
                ...
                <div className="tag">
                  <div className="tag__item">
                    {bookingHistoryData?.type || "Loading..."}
                  </div>
                  <div className="tag__item">
              ...
              <div className="wrapper">
                <div className="name-room">
                  {bookingHistoryData?.roomTypeName}
                </div>
                ...
                <div className="rating">
                  ...
                  <div className="reviews">
                    {bookingHistoryData?.ratingCount + " lượt đánh giá"}
                  </div>
                </div>
                <div className="facilities">
                  <div className="facilities__wrapper">
                    {bookingHistoryData?.facilities.map((item) => {
                      return (
                        <div className="facilities__wrapper__item">{item}</div>
                      );
                    })}
                  </div>
                  ...
                  <div className="view-detail">
                    <Button
                      onClick={() => {
                        navigate("/detail/" + bookingHistoryData.accomId);
                      }}
                      className="outline"
                    >
                      Xem chi tiết
            ...
            <div className="bottom">
              <div className="bottom__item">
                ...
                <div className="bottom__item__content">
                  {bookingHistoryData?.recvDate
                    ? bookingHistoryData.recvDate
                        ?.toDate()
                        .toLocaleDateString("vi-VN")
                    : ""}
                </div>
                <div className="bottom__item__description">
                  {"Từ " +
                    (bookingHistoryData?.recvDate
        ...
        <div className="two-columns">
          <div className="section" id="left">
            <div ref={customerInfoRef} className="title">
              Thông tin người đặt
            </div>
            <Input
              error={error.name}
              ...
              label="Họ tên"
              disable={!isCanEdit}
              value={bookingHistoryData?.customerName}
            />
            <Input
              error={error.email}
              ...
              label="Email"
              disable={!isCanEdit}
              value={bookingHistoryData?.customerMail}
            />
            <Input
              ...
              label="Số điện thoại"
              disable={!isCanEdit}
              value={bookingHistoryData?.customerPhone}
            />
          </div>
          <div className="section" id="right">
            ...
            <div className="row">
              ...
              <div className="row__price-room">
                <div className="row__price-room__old">
                  {bookingHistoryData?.orderOriginalPrice + " đ" || "..."}
                </div>
                <div className="row__price-room__new">
                  {bookingHistoryData?.oneRoomPrice.toLocaleString("vi-VN") ||
                    "..."}
                </div>
              </div>
            </div>
            ...
            <div className="total-price">
              ...
              <div className="total-price__column">
                <div className="total-price__column__price">
                  {bookingHistoryData?.orderPrice.toLocaleString("vi-VN") +
                    " đ" || "..."}
                </div>
